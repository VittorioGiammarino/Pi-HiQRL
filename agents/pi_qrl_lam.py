...
class PI_QRL_LAM_Agent(flax.struct.PyTreeNode):
    """Physics-informed Quasimetric RL with minmax objective (Pi-QRL-lambda) agent.
...
def get_config():
    config = ml_collections.ConfigDict(
        dict(
            ...
            agent_name='pi_qrl_lam',  # Agent name.
